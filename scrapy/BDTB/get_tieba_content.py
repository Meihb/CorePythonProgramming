...
class BaiduTieBa:
    ...
    def __init__(self, url, seeLZ=0, floorTag=1):
        self.url = url
    ...
    def newFileAccTitle(self, title):
        if title is not None:
            ...
            self.file = open(self.defultTitle + ".txt", "wb+")
...
url = "https://tieba.baidu.com/p/5777346571"
...
baidutieba = BaiduTieBa(url, 1, 1)  # 实例化一个对象
